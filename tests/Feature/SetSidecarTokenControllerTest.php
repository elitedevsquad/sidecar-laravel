...
it('stores token in cookie if valid', function () {
    Config::set('devsquad-sidecar-bridge.auth_token', 'my-token');
...
it('fails if token is missing or invalid', function () {
    Config::set('devsquad-sidecar-bridge.auth_token', 'expected');
...
it('fails if auth_token is not configured', function () {
    Config::set('devsquad-sidecar-bridge.auth_token', null);
